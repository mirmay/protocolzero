...
- Citations and sources (AI invents fake sources regularly)
...
- Reviewed by human employees (for quality control)
- Used to train future models (your data teaches the AI)
...
Proprietary data, trade secrets, unreleased product information, internal communications, client data.

**Legal documents:**  
Contracts, legal strategy, case details (attorney-client privilege doesn't extend to AI service).

**Intimate details:**  
Personal relationships, sexual information, anything you wouldn't want exposed.

**Children's information:**  
Names, photos, schools, schedules, anything about minors.

**Complete code with sensitive logic:**  
Authentication systems, encryption implementations, security mechanisms.

**Safe to input:**

- General questions
- Public information
- Hypothetical scenarios (anonymized)
- Learning requests ("Explain how X works")
...
AI companies use conversations to: 
- Improve model accuracy
- Teach AI new information
- Correct mistakes
- Expand capabilities

**Your input becomes part of training data.**

Future versions of AI might generate responses based on patterns from your conversations.
...
**Check service privacy settings:**

Look for:
- "Data controls"
- "Privacy settings"
- "Do not train on my data"
- "Improve the model" (disable this)
...
Some AI tools emphasize privacy:
...
Separate accounts/sessions for different purposes: 
- Sensitive work (use work-approved tools with data protections)
- Personal learning (general account)
- Casual use (throwaway account)

Don't mix contexts in one conversation history.
...
- **10 minutes:** Review privacy settings on AI services you use, opt out of training if available. 
- **15 minutes:** Delete conversation history from AI services. 
- **5 minutes:** Create separate account for sensitive vs casual AI use.
- **Ongoing:** Before pasting anything into AI, ask: "Would I publish this publicly?"


## 31. Voice Assistants: Siri, Alexa, Google Assistant
...
Microphone is always on, listening for wake word ("Hey Siri," "Alexa," "OK Google").

**Processing:**

**Local processing (sometimes):**  
Simple wake word detection happens on device. 

**Cloud processing (usually):**  
Once wake word detected, audio is sent to company servers for processing.

Your voice command is: 
- Transmitted to company servers
- Converted to text
- Processed to understand intent
- Response generated
- Response sent back to device

**What gets recorded:**

Officially: Only audio after wake word. 

Reality: 
- False activations (thinks it heard wake word when it didn't)
- Accidental triggers (words that sound like wake word)
- Background conversations sometimes captured
- Longer recordings than just your command (buffer before/after)

**What happens to recordings:**

- Stored on company servers
- Associated with your account
- Sometimes reviewed by human employees (for quality control, training)
- Used to improve voice recognition
- Analyzed for patterns, preferences, habits
- Can be subpoenaed by law enforcement

### **[RECOMMENDED]** Deleting Recording History

Most voice assistants store history of your voice interactions.

**You can review and delete:**

**Process (general pattern):**

1. Log into account on web or app
2. Find privacy or voice history settings
3. Review recordings (often includes audio playback and transcription)
4. Delete individual recordings or entire history
5. Disable saving future recordings (if option exists)
...
Most voice assistants have hardware mute button that physically disconnects microphone.

LED indicator shows when muted (usually red).

**When to mute:**

**Sensitive conversations:**  
Medical appointments, legal discussions, financial planning, relationship talks, therapy sessions.

**Private moments:**  
Bedroom, bathroom, anywhere you expect privacy.
...
Voice assistants offer real convenience: 
- Hands-free control (cooking, driving, multitasking)
- Accessibility (visual impairments, mobility limitations)
- Home automation (lights, temperature, locks)
- Quick information (weather, timers, calculations)

**But cost is surveillance.**
...
**Disable purchasing:**  
Prevent accidental or unauthorized orders.
...
**Not muting during private conversations**  
Assume anything said near voice assistant might be recorded.

**Connecting to sensitive smart home devices**  
...
- **10 minutes:** Review and delete all voice recording history. 
- **5 minutes:** Enable automatic deletion of recordings after shortest time period available.
- **2 minutes:** Mute voice assistant when not actively using it.
- **15 minutes:** Move voice assistants from bedrooms and bathrooms to less private spaces.


## 32. Life Automation: IFTTT, Shortcuts, Zapier

Automation services connect apps and devices to perform actions automatically.
...
**Automation services work by connecting to your accounts:**

You authorize automation service to: 
- Access your email
- Post to social media
- Control smart home devices
- Read and write files in cloud storage
- Access calendar, contacts, location
- Send messages
...
**Full access:**  
Automation can read everything, write everything, delete everything in that service.

**Limited access (if available):**  
Read-only, or specific scopes (e.g., "post to Twitter" but not "read direct messages").

**Choose minimal necessary permissions.**
...
**Can I accomplish this with less access?**  
Alternative approach with narrower permissions? 

**Do I trust this automation service?**  
Research: 
- Company reputation
...
Most services show "Apps with access to your account" in security settings.

For each connected app:
- Do I still use this automation?
- Do I even remember creating this? 
- Is the permission level appropriate?
- Is this service still trustworthy?
...
If automation service has added more granular permission options since you connected, update to minimal necessary.
...
Failed automations can cause problems (repeated attempts, partial completion, notification spam).

### API Token Security

**API (Application Programming Interface) tokens** are keys that grant access to your account. 
...
Don't post in forums, paste in chat, commit to public code repositories.

**Rotate tokens periodically:**  
Generate new token, update automations, delete old token.
...
- **20 minutes:** Audit connected apps and services for your three most-used accounts (email, social media, cloud storage).
- **15 minutes:** Revoke access for any app/automation you don't use or recognize.
