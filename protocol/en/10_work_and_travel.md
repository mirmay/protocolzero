...
### **[CRITICAL]** Why Not Use Work Email for Personal Accounts

**Problems with using work email for personal purposes:**
...
Recovering accounts tied to defunct email is difficult or impossible.

**Employer can see everything:**
...
Using work email for personal business appears unprofessional.
...
- Personal apps and data may be accessible to employer
...
Personal photos, messages, files mixed with work data on same device.

If device compromised, both personal and work data exposed.
...
- Password policies
- Update schedules
- Restrictions on what apps you can install

Your device, their rules.

**Risks to employer:**

**Company data on uncontrolled device:**
...
- Don't store sensitive personal data on device used for work

### Second Device vs User Profiles
...
- Work management software affects entire device
...
**Review employment contract and company policies** about data and intellectual property.

**Ask explicitly** what you're allowed to take.

**Transfer personal data** to personal accounts before losing access.

**Delete personal data** from work devices (but not work data).
...
- Delete company data to hide your tracks (destruction of company property)
...
Voice calls, video meetings in public can be overheard.

**Device theft:**

Laptop, phone, tablet left unattended for "just a minute" gets stolen.
...
1. Lock screen every time you stand up
2. Take valuables with you (phone, wallet) or leave trusted companion to watch
...
### **[CRITICAL]** Backup Before Leaving Home

**Working remotely increases risk:**

- Device lost or stolen while traveling
- Damage (spilled coffee, drops, accidents)
- Technical failure at inconvenient time

**Backup before leaving home:**

Everything critical should be backed up and accessible if device is lost.

**Cloud sync:**

Active projects synced to cloud storage before you leave.

**Full backup:**

Complete device backup to external drive or cloud (in case of total device loss).

**Access from other devices:**

Important files accessible from phone or web browser if laptop is unavailable.

**Test restore:**

Verify you can actually access backed-up data from another device.
...
- Critical files in multiple locations

**Backup is not optional for remote work.**

Device loss while traveling with no backup = work lost, deadlines missed, data gone.
...
**Why backup before travel is critical:**
...
Luggage handling, accidents, weather.

**Full backup before departure:**

1. Complete backup of all devices (computer, phone, tablet)
2. Store backup at home (not traveling with you)
3. Verify backup is complete and accessible
4. Document what's backed up and how to restore
...
**More common while traveling** (you're less likely to notice immediately).

**Physical SIM theft:**

Device stolen, SIM removed, used for fraud.

**International roaming charges:**

Unexpected expensive charges if roaming not properly configured.
...
- Use eSIM if available (more secure)
- Or remove physical SIM when not needed
- Set SIM PIN
- Monitor for unusual activity (unexpected charges, lost service)

**International roaming:**

- Understand costs before enabling
- Use WiFi when possible
- Consider local SIM for extended travel
- Or international roaming plan from home carrier

### Access to Accounts from Foreign Country

**Geographic restrictions:**

Some services block access from certain countries.

You travel, try to access account, denied.

**Services that commonly block:**

- Banking
- Streaming (content licensing restrictions)
- Government services
- Some email providers

**Two-factor authentication complications:**

**SMS-based 2FA while traveling:**

- International SMS might be delayed or blocked
...
Before leaving, verify you can access critical accounts via VPN (simulates being in different country).
...
**6. Secure storage of backup access:**

Recovery codes, backup authentication methods stored securely (encrypted cloud, physical paper in secure location at home).

### **[CRITICAL]** What to Do If You Lose Phone Abroad
...
- Banking passwords
- Any sensitive account

Especially important if device wasn't encrypted or didn't have strong lock screen.

**6. Revoke device authorization:**

Log into accounts, remove lost device from trusted devices list.
...
**9. Contact embassy/consulate (if needed):**

If phone contained critical travel documents or you need assistance.

**10. Restore from backup:**

Once you have replacement device, restore from backup made before travel.
